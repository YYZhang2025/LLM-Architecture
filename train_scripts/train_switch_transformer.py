...
from llm.models.swtich_transformer_model import ModelConfig, SwitchTransformer
...
if __name__ == "__main__":
    ...
    model = SwitchTransformer(model_config).to(train_config.device)
